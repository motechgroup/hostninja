<x-admin-layout>
    ...
    <div class="space-y-8" x-data="{ currentTab: '{{ $tab }}', showNewPlanModal: false }">
        ...
        <div class="flex items-center gap-2 border-b border-slate-200 pb-2 overflow-x-auto">
            <a href="{{ route('admin.dashboard') }}" :class="currentTab === 'overview' ? 'border-[#0059bb] text-[#0059bb] bg-[#0059bb]/10 font-bold' : 'border-transparent text-slate-600 hover:text-slate-900'" class="px-5 py-2.5 border-b-2 text-xs rounded-t-xl transition-all whitespace-nowrap">Overview Analytics</a>
            <a href="{{ route('admin.dashboard', ['tab' => 'users']) }}" :class="currentTab === 'users' ? 'border-[#0059bb] text-[#0059bb] bg-[#0059bb]/10 font-bold' : 'border-transparent text-slate-600 hover:text-slate-900'" class="px-5 py-2.5 border-b-2 text-xs rounded-t-xl transition-all whitespace-nowrap">Users & Accounts ({{ $customerCount }})</a>
            <a href="{{ route('admin.dashboard', ['tab' => 'servers']) }}" :class="currentTab === 'servers' ? 'border-[#0059bb] text-[#0059bb] bg-[#0059bb]/10 font-bold' : 'border-transparent text-slate-600 hover:text-slate-900'" class="px-5 py-2.5 border-b-2 text-xs rounded-t-xl transition-all whitespace-nowrap">Server Nodes ({{ count($servers) }})</a>
            <a href="{{ route('admin.dashboard', ['tab' => 'plans']) }}" :class="currentTab === 'plans' ? 'border-[#0059bb] text-[#0059bb] bg-[#0059bb]/10 font-bold' : 'border-transparent text-slate-600 hover:text-slate-900'" class="px-5 py-2.5 border-b-2 text-xs rounded-t-xl transition-all whitespace-nowrap">Packages ({{ count($hostingPlans) }})</a>
            <a href="{{ route('admin.dashboard', ['tab' => 'tickets']) }}" :class="currentTab === 'tickets' ? 'border-[#0059bb] text-[#0059bb] bg-[#0059bb]/10 font-bold' : 'border-transparent text-slate-600 hover:text-slate-900'" class="px-5 py-2.5 border-b-2 text-xs rounded-t-xl transition-all whitespace-nowrap">Support Queue ({{ $openTicketsCount }})</a>
            <a href="{{ route('admin.dashboard', ['tab' => 'invoices']) }}" :class="currentTab === 'invoices' ? 'border-[#0059bb] text-[#0059bb] bg-[#0059bb]/10 font-bold' : 'border-transparent text-slate-600 hover:text-slate-900'" class="px-5 py-2.5 border-b-2 text-xs rounded-t-xl transition-all whitespace-nowrap">Invoices & Billing</a>
        </div>
